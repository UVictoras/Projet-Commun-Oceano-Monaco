...
function Above(props) {
    ...
    return <div className="Act ">
        ...
        <div className="objectiv absolute bg-white rounded-lg bottom-12 left-12 w-[435px]">
            <div className="flex mt-6 items-center space-x-[206px] extraBold800 mx-[30px]">
                <div>
                    <h1 className="text-[21px]">Objectifs</h1>
                </div>
                <div className="">
            ...
            <div className="mt-[38px] flex ml-[32px] mr-[30px] flex items-start" >
                ...
                <img src="img/icon/chest.svg" alt="chest make it blue" className="ml-2 mt-[26px] mb-[50px] " />

            </div>

        </div>
        <div className="bottomIcon flex items-end absolute bottom-8 left-1/2 centerIcon space-x-3 ">
            <button className="w-[60px] h-[60px] p-3 rounded-2xl border-4 border-solid border-neutral-200 bg-neutral-50 flex items-center locateButton  z-20">
                <img src="img/icon/locate.svg" alt="locate make it blue" />
            </button>
            <button className="w-[60px] h-[60px] p-3 rounded-2xl border-4 border-solid border-neutral-200 bg-neutral-50 flex items-center likeButton z-20">
                <img src="img/icon/hearth/hearthGrey.svg" alt="coeur Make it blue" />
            </button>
            <button className="w-[60px] h-[60px] p-3 rounded-2xl border-4 border-solid border-neutral-200 bg-neutral-50 flex items-center filterButton z-20 ">
