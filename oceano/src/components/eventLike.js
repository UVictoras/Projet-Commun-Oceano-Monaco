export default function EventLike(props) {
    return <div className="border-2 w-full h-[176px] rounded-2xl flex space-x-7">
        <div className="w-1/3">
            <img src={props.event.Image} alt="dolphin make it blue" className="h-44 w-44" />
        </div>
        <div className="w-2/3 my-5">
            <div className="flex">
                <h2 className="extraBold800 text-base fontColor3C">{props.event.Title}</h2>
            ...
            <p className="nunito400 fontColor3C text-sm mt-3">{props.event.Description}</p>
