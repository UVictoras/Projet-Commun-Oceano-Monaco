    ...
    return <div className='mx-9 '>
        ...
        <div className='filter '>
            <div className='filter flex space-x-2.5 my-3.5 mb-7'>
                <div className=' w-[94px] h-[31px] bg-white border-2 border-neutral-200 rounded-xl flex items-center justify-center space-x-2'>
                    <img src='img/icon/petition.svg' alt='petition make it blue' className='w-3' />
                    <p className='text-sm extraBoldNunito'>Pétition</p>
                </div>
                <div className='donation w-[94px] h-[31px] rounded-xl flex items-center justify-center space-x-2 '>
                    <img src='img/icon/coin.png' alt='coin make it blue' className='w-3' />
                    <p className='text-sm extraBoldNunito'>Donation</p>
                </div>
                <div className="date w-[100px] h-[31px] bg-white border-2 border-neutral-200 rounded-xl flex items-center justify-center space-x-2 ">
                    <img src='img/event/date.svg' alt='date make it blue' className='w-4' />
                    <p className='text-sm extraBoldNunito'>8 Juin</p>
                </div>
                <div className=' w-40 h-[31px] bg-white border-2 border-neutral-200 rounded-xl flex items-center justify-center space-x-2'>
