export default function PlacePing(props) {
    return <div className=" z-40 flex ">
        <div className="">
            <svg xmlns="http://www.w3.org/2000/svg" width="355" height="116" viewBox="0 0 455 116" fill="none" className="relative">
            ...
            <p className="absolute top-0 mt-8 px-4 fontColor3C extraBoldNunito text-xl">Pour créer une action,<br /> sélectionne un lieu sur la carte !</p>
        </div>
