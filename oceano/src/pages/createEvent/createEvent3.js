                ...
                <div className="border-2 border-neutral-200 rounded-2xl h-3/4 flex items-center justify-center">
                    <div>
                        <div className="flex justify-center">
                            <img src="img/impact/addImage.png" alt="add image make it blue" className="" />
                        </div>
                        <input type="file" className="blueTextColor border-2 border-neutral-200 rounded-2xl px-8 py-3 extraBoldNunito" placeholder="Ajouter une image" />
