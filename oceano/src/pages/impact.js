...
function Impact(props){
    return <div className="impact">
        ...
        <div class="grid grid-cols-3 gap-4 place-content-center h-48 ...">
            <div><p className ="grid place-content-center h-48 ...">01</p></div>
            <div><p className ="grid place-content-center h-48 ...">02</p></div>
            <div><p className ="grid place-content-center h-48 ...">03</p></div>
