...
function Signup(props) {
    ...
    return <div className="h-screen w-full flex flex-col items-center justify-center z-20 bg-white container mx-auto px-4 mt-">
        ...
        <div className="title flex lg:items-center items-end">
            ...
            <h1 className=" grid place-content-center text font-medium blackNunito titleFont text-[26px] ">Créer ton profil</h1>
        </div>
        <div className="text h-2/3 mt-4 w-full">
            <form className="max-w-sm mx-auto" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-5">
                    <label for="date" className="block mb-2 text-xs mediumNunito  ">Tu dois avoir au moins 13 ans pour utiliser Make it Blue. Pour en savoir plus, tu peux consulter notre
                ...
                <div className="mb-5">
                    <input type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl  block w-full p-2.5 " placeholder="Nom d'utilisateur" name="first name" {...register("pseudo")} required></input>
                </div>
                <div className="mb-5">
                    <input type="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl  block w-full p-2.5 " placeholder="E-mail" name="email" {...register("email")} required></input>
                </div>
                <div className="mb-5">
                ...
                <div className="mb-5">
                    <button type="submit" className="text-white blueButton  font-medium rounded-xl text-sm w-full p-2.5  text-center ">CREER MON COMPTE</button>
                </div>
            </form>
            ...
            <div className="mb-3  max-w-sm mx-auto">
                ...
                <p className="block text-xs regularNunito ">
